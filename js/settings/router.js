var _router = new VueRouter({
    routes: [
        ...
        // Painel
        { name: 'system-painel', path: '/system-painel', component: { 
        ...
        if (!app.registrando_usuario) {
            new daoclient.DaoClinica().get(token)
                .done(function(data) {
                    ...
                    console.log(settings.websocketPath);
                    // settings.localContextPath = "http://"app.user.model.fields.ip_central+":8080/reabilitycenter/";
